...
%=========================================================================
function EG302400 = ErrorGrowthRI302400
...
S=[];tao=8400;delta=600;
V = importdata('exp302400RIv.txt');%Time series with zero noise amplitude
for i=1:40 % number of realization
    filename = sprintf('exp302400RIv%d.txt',i);% loading the v-wind data for all realization
...
%hold off;
EG302400=sqrt(sum/i);% calculating the error growth
% figure(2);
% set(gca, 'GridLineStyle', ':') %dotted grid lines
% set(gca,'FontSize',14,'LineWidth',2.75)
