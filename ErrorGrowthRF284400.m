...
%=========================================================================
function EG284400 = ErrorGrowthRF284400
...
S=[];tao=7900;delta=600;
V = importdata('exp284400RFv.txt');%Time series with zero noise amplitude
for i=1: 30 % number of realization
    filename = sprintf('exp284400RFv%d.txt',i);% loading the v-wind data for all realization
...
EG284400=sqrt(sum/i);% calculating the error growth
%   hold on;
