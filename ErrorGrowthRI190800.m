...
%=========================================================================
function EG190800 = ErrorGrowthRI190800
...
S=[];tao=5300;delta=600;
V = importdata('exp190800RIv.txt');%Time series with zero noise amplitude
for i=1:40 % number of realization
    filename = sprintf('exp190800RIv%d.txt',i);% loading the v-wind data for all realization
...
%hold off;
EG190800=sqrt(sum/i);% calculating the error growth
% figure(2);
% set(gca, 'GridLineStyle', ':') %dotted grid lines
% set(gca,'FontSize',14,'LineWidth',2.75)
