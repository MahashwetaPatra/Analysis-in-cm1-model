...
%=========================================================================
function EG237600 = ErrorGrowthRI237600
...
V = importdata('exp237600RIv.txt');%Time series with zero noise amplitude
for i=1:40 % number of realization
    filename = sprintf('exp237600RIv%d.txt',i);% loading the v-wind data for all realization
