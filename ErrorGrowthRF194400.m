...
%=========================================================================
function EG194400 = ErrorGrowthRF194400
...
V = importdata('exp194400RFv.txt');%Time series with zero noise amplitude
for i=1: 30 % number of realization
    filename = sprintf('exp194400RFv%d.txt',i);% loading the v-wind data for all realization
