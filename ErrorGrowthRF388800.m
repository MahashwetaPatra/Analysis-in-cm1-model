...
%=========================================================================
function EG388800 = ErrorGrowthRF388800
...
V = importdata('exp388800RFv.txt');%Time series with zero noise amplitude
for i=1: 30 % number of realization
    filename = sprintf('exp388800RFv%d.txt',i);% loading the v-wind data for all realization
