...
%=========================================================================
function EG273600 = ErrorGrowthRF273600
...
S=[];tao=7600;delta=600;
V = importdata('exp273600RFv.txt');%Time series with zero noise amplitude
for i=1: 30 % number of realization
    filename = sprintf('exp273600RFv%d.txt',i);% loading the v-wind data for all realization
...
EG273600=sqrt(sum/i);% calculating the error growth
end