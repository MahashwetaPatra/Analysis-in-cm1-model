...
function EG367200 = ErrorGrowthRF367200
...
V = importdata('exp367200RFv.txt');%Time series with zero noise amplitude
for i=1: 30 % number of realization
    filename = sprintf('exp367200RFv%d.txt',i);% loading the v-wind data for all realization
