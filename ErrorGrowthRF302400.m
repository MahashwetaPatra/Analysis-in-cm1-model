...
%=========================================================================
function EG302400 = ErrorGrowthRF302400
...
V = importdata('exp302400RFv.txt');%Time series with zero noise amplitude
for i=1: 30 % number of realization
    filename = sprintf('exp302400RFv%d.txt',i);% loading the v-wind data for all realization
