...
V = importdata('exp172800R5Fv.txt');%Time series with zero noise amplitude
for i=1: 29 % number of realization
    filename = sprintf('exp172800R5Fv%d.txt',i);% loading the v-wind data for all realization
