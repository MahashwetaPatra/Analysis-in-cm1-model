...
%=========================================================================
function EG280800 = ErrorGrowthRF280800
...
S=[];tao=7800;delta=600;
V = importdata('exp280800RFv.txt');%Time series with zero noise amplitude
for i=1: 30 % number of realization
    filename = sprintf('exp280800RFv%d.txt',i);% loading the v-wind data for all realization
...
EG280800=sqrt(sum/i);% calculating the error growth
%   hold on;
