...
Noise=[];EB=[];tau=172800;
EB1 = exp172800RF; Noise1=[0.01;0.01;0.01]; 
plot(Noise1,EB1,'-red', 'markersize',20)
hold on;
EB2 = exp172800R2F;Noise2=[0.02;0.02;0.02]; 
 plot(Noise2,EB2,'-red', 'markersize',20)
 hold on;
 EB3 = exp172800R3F; Noise3=[0.03;0.03;0.03];
 plot(Noise3,EB3,'-red', 'markersize',20)
 EB4 = exp172800R4F; Noise4=[0.04;0.04;0.04];
 plot(Noise4,EB4,'-red', 'markersize',20)
 EB5 = exp172800R5F; Noise5=[0.05;0.05;0.05];
 plot(Noise5,EB5,'-red', 'markersize',20)
 EB6 = exp172800R6F; Noise6=[0.06;0.06;0.06];
 plot(Noise6,EB6,'-red', 'markersize',20)
 EB7 = exp172800R7F;Noise7=[0.07;0.07;0.07];
 plot(Noise7,EB7,'-red', 'markersize',20)
 EB8 = exp172800R8F;Noise8=[0.08;0.08;0.08];
 plot(Noise8,EB8,'-red', 'markersize',20)
EB9 = exp172800R9F; Noise9=[0.09;0.09;0.09];
