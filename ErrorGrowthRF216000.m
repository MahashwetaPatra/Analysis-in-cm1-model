...
%=========================================================================
function EG216000 = ErrorGrowthRF216000
...
V = importdata('exp216000RFv.txt');%Time series with zero noise amplitude
for i=1: 30 % number of realization
    filename = sprintf('exp216000RFv%d.txt',i);% loading the v-wind data for all realization
