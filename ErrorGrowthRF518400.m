...
%=========================================================================
function EG518400 = ErrorGrowthRF518400
...
S=[];tao=14400;delta=600;
V = importdata('exp518400RFv.txt');%Time series with zero noise amplitude
for i=1: 30 % number of realization
    filename = sprintf('exp518400RFv%d.txt',i);% loading the v-wind data for all realization
...
EG518400=sqrt(sum/i);% calculating the error growth
%   hold on;
