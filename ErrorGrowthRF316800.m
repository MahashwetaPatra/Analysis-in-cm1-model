...
%=========================================================================
function EG316800 = ErrorGrowthRF316800
...
S=[];tao=8800;delta=600;
V = importdata('exp316800RFv.txt');%Time series with zero noise amplitude
for i=1: 30 % number of realization
    filename = sprintf('exp316800RFv%d.txt',i);% loading the v-wind data for all realization
...
EG316800=sqrt(sum/i);% calculating the error growth
%   hold on;
