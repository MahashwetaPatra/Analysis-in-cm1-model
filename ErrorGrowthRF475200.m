...
%=========================================================================
function EG475200 = ErrorGrowthRF475200
...
V = importdata('exp475200RFv.txt');%Time series with zero noise amplitude
for i=1: 30 % number of realization
    filename = sprintf('exp475200RFv%d.txt',i);% loading the v-wind data for all realization
