...
%=========================================================================
function EG288000 = ErrorGrowthRF288000
...
S=[];tao=8000;delta=600;
V = importdata('exp288000RFv.txt');%Time series with zero noise amplitude
for i=1: 30 % number of realization
    filename = sprintf('exp288000RFv%d.txt',i);% loading the v-wind data for all realization
...
EG288000=sqrt(sum/i);% calculating the error growth
%   hold on;
