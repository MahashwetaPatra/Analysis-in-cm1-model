...
function EG324000 = ErrorGrowthRF324000
...
S=[];tao=9000;delta=600;
V = importdata('exp324000RFv.txt');%Time series with zero noise amplitude
for i=1: 30 % number of realization
    filename = sprintf('exp324000RFv%d.txt',i);% loading the v-wind data for all realization
...
EG324000=sqrt(sum/i);% calculating the error growth
%  hold on;
