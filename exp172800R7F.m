...
V = importdata('exp172800R7Fv.txt');%Time series with zero noise amplitude
for i=1: 29 % number of realization
    filename = sprintf('exp172800R7Fv%d.txt',i);% loading the v-wind data for all realization
