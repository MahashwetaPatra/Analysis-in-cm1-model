...
%=========================================================================
function EG216000 = ErrorGrowthRI216000
...
S=[];tao=6000;delta=600;
V = importdata('exp216000RIv.txt');%Time series with zero noise amplitude
for i=1:40 % number of realization
    filename = sprintf('exp216000RIv%d.txt',i);% loading the v-wind data for all realization
...
%hold off;
EG216000=sqrt(sum/i);% calculating the error growth
% figure(2);
% set(gca, 'GridLineStyle', ':') %dotted grid lines
% set(gca,'FontSize',14,'LineWidth',2.75)
