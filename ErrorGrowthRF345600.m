...
%=========================================================================
function EG345600 = ErrorGrowthRF345600
...
V = importdata('exp345600RFv.txt');%Time series with zero noise amplitude
for i=1: 30 % number of realization
    filename = sprintf('exp345600RFv%d.txt',i);% loading the v-wind data for all realization
