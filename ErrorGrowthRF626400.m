...
%=========================================================================
function EG626400 = ErrorGrowthRF626400
...
S=[];tao=17400;delta=600;
V = importdata('exp626400RFv.txt');%Time series with zero noise amplitude
for i=1: 30 % number of realization
    filename = sprintf('exp626400RFv%d.txt',i);% loading the v-wind data for all realization
...
EG626400=sqrt(sum/i);% calculating the error growth
%   hold on;
