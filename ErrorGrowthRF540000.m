...
%=========================================================================
function EG540000 = ErrorGrowthRF540000
...
S=[];tao=15000;delta=600;
V = importdata('exp540000RFv.txt');%Time series with zero noise amplitude
for i=1: 30 % number of realization
    filename = sprintf('exp540000RFv%d.txt',i);% loading the v-wind data for all realization
...
EG540000=sqrt(sum/i);% calculating the error growth
%   hold on;
