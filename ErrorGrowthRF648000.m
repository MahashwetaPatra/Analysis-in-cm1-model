...
function EG648000 = ErrorGrowthRF648000
...
S=[];tao=18000;delta=600;
V = importdata('exp648000RFv.txt');%Time series with zero noise amplitude
for i=1: 30 % number of realization
    filename = sprintf('exp648000RFv%d.txt',i);% loading the v-wind data for all realization
...
EG648000=sqrt(sum/i);% calculating the error growth
%   hold on;
