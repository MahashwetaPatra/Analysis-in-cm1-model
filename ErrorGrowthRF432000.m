...
%=========================================================================
function EG432000 = ErrorGrowthRF432000
...
S=[];tao=12000;delta=600;
V = importdata('exp432000RFv.txt');%Time series with zero noise amplitude
for i=1: 30 % number of realization
    filename = sprintf('exp432000RFv%d.txt',i);% loading the v-wind data for all realization
...
EG432000=sqrt(sum/i);% calculating the error growth
%   hold on;
