...
V = importdata('exp172800R4Fv.txt');%Time series with zero noise amplitude
for i=1: 30 % number of realization
    filename = sprintf('exp172800R4Fv%d.txt',i);% loading the v-wind data for all realization
