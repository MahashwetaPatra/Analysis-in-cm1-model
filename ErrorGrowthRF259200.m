...
%=========================================================================
function EG259200 = ErrorGrowthRF259200
...
V = importdata('exp259200RFv.txt');%Time series with zero noise amplitude
for i=1: 30 % number of realization
    filename = sprintf('exp259200RFv%d.txt',i);% loading the v-wind data for all realization
