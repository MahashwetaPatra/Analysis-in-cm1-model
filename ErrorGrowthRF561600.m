...
%=========================================================================
function EG561600 = ErrorGrowthRF561600
...
S=[];tao=15600;delta=600;
V = importdata('exp561600RFv.txt');%Time series with zero noise amplitude
for i=1: 30 % number of realization
    filename = sprintf('exp561600RFv%d.txt',i);% loading the v-wind data for all realization
...
EG561600=sqrt(sum/i);% calculating the error growth
%   hold on;
