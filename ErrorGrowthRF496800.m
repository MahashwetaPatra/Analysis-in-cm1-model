...
%=========================================================================
function EG496800 = ErrorGrowthRF496800
...
V = importdata('exp496800RFv.txt');%Time series with zero noise amplitude
for i=1: 30 % number of realization
    filename = sprintf('exp496800RFv%d.txt',i);% loading the v-wind data for all realization
