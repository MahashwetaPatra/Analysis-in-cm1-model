...
%=========================================================================
function EG324000 = ErrorGrowthRI324000
...
V = importdata('exp324000RIv.txt');%Time series with zero noise amplitude
for i=1:40 % number of realization
    filename = sprintf('exp324000RIv%d.txt',i);% loading the v-wind data for all realization
