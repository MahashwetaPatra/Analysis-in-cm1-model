...
%=========================================================================
function EG453600 = ErrorGrowthRF453600
...
S=[];tao=12600;delta=600;
V = importdata('exp453600RFv.txt');%Time series with zero noise amplitude
for i=1: 30 % number of realization
    filename = sprintf('exp453600RFv%d.txt',i);% loading the v-wind data for all realization
...
EG453600=sqrt(sum/i);% calculating the error growth
%   hold on;
