...
%=========================================================================
function EG583200 = ErrorGrowthRF583200
...
S=[];tao=16200;delta=600;
V = importdata('exp583200RFv.txt');%Time series with zero noise amplitude
for i=1: 30 % number of realization
    filename = sprintf('exp583200RFv%d.txt',i);% loading the v-wind data for all realization
...
EG583200=sqrt(sum/i);% calculating the error growth
%   hold on;
