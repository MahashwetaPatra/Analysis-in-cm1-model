...
%=========================================================================
function EG259200 = ErrorGrowthRI259200
...
S=[];tao=7200;delta=600;
V = importdata('exp259200RIv.txt');%Time series with zero noise amplitude
for i=1:40 % number of realization
    filename = sprintf('exp259200RIv%d.txt',i);% loading the v-wind data for all realization
...
%hold off;
EG259200=sqrt(sum/i);% calculating the error growth
% figure(2);
% set(gca, 'GridLineStyle', ':') %dotted grid lines
% set(gca,'FontSize',14,'LineWidth',2.75)
