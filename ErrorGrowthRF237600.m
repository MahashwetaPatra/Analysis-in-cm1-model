...
%=========================================================================
function EG237600 = ErrorGrowthRF237600
...
S=[];tao=6600;delta=600;
V = importdata('exp237600RFv.txt');%Time series with zero noise amplitude
for i=1: 30 % number of realization
    filename = sprintf('exp237600RFv%d.txt',i);% loading the v-wind data for all realization
...
EG237600=sqrt(sum/i);% calculating the error growth
%   hold on;
