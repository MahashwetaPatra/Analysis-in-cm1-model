...
%=========================================================================
function EG194400 = ErrorGrowthRI194400
...
S=[];tao=5400;delta=600;
V = importdata('exp194400RIv.txt');%Time series with zero noise amplitude
for i=1:39 % number of realization
    filename = sprintf('exp194400RIv%d.txt',i);% loading the v-wind data for all realization
...
%hold off;
EG194400=sqrt(sum/i);% calculating the error growth
% figure(2);
% set(gca, 'GridLineStyle', ':') %dotted grid lines
% set(gca,'FontSize',14,'LineWidth',2.75)
