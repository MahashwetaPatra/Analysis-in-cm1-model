...
%=========================================================================
function EG604800 = ErrorGrowthRF604800
...
S=[];tao=16800;delta=600;
V = importdata('exp604800RFv.txt');%Time series with zero noise amplitude
for i=1: 30 % number of realization
    filename = sprintf('exp604800RFv%d.txt',i);% loading the v-wind data for all realization
...
EG604800=sqrt(sum/i);% calculating the error growth
%   hold on;
