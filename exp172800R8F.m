...
V = importdata('exp172800R8Fv.txt');%Time series with zero noise amplitude
for i=1: 28 % number of realization
    filename = sprintf('exp172800R8Fv%d.txt',i);% loading the v-wind data for all realization
