...
%=========================================================================
function EG280800 = ErrorGrowthRI280800
...
V = importdata('exp280800RIv.txt');%Time series with zero noise amplitude
for i=1:40 % number of realization
    filename = sprintf('exp280800RIv%d.txt',i);% loading the v-wind data for all realization
